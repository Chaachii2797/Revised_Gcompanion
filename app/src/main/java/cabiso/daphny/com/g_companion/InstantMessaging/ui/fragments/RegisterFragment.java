...
import cabiso.daphny.com.g_companion.InstantMessaging.core.core.registration.RegisterContract;
import cabiso.daphny.com.g_companion.InstantMessaging.core.core.registration.RegisterPresenter;
import cabiso.daphny.com.g_companion.InstantMessaging.core.core.user.user.add.AddUserContract;
import cabiso.daphny.com.g_companion.InstantMessaging.core.core.user.user.add.AddUserPresenter;
...
public class RegisterFragment extends Fragment implements View.OnClickListener, RegisterContract.View, AddUserContract.View {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View fragmentView = inflater.inflate(R.layout.fragment_chat_register, container, false);
