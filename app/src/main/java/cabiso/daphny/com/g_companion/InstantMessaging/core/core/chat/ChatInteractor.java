package cabiso.daphny.com.g_companion.InstantMessaging.core.core.chat;
...
import cabiso.daphny.com.g_companion.InstantMessaging.fcm.FcmNotificationBuilder;
...
public class ChatInteractor implements ChatContract.Interactor {
    ...
    public void sendMessageToFirebaseUser(final Context context, final Chat chat, final String receiverFirebaseToken) {
        ...
        databaseReference.child(MessagingContants.ARG_CHAT_ROOMS).getRef().addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.hasChild(room_type_1)) {
                    Log.e(TAG, "sendMessageToFirebaseUser: " + room_type_1 + " exists");
                    databaseReference.child(MessagingContants.ARG_CHAT_ROOMS).child(room_type_1).child(String.valueOf(chat.timestamp)).setValue(chat);
                } else if (dataSnapshot.hasChild(room_type_2)) {
                    Log.e(TAG, "sendMessageToFirebaseUser: " + room_type_2 + " exists");
                    databaseReference.child(MessagingContants.ARG_CHAT_ROOMS).child(room_type_2).child(String.valueOf(chat.timestamp)).setValue(chat);
                } else {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.hasChild(room_type_1)) {
                    ...
                    FirebaseDatabase.getInstance()
                            .getReference()
                            .child(MessagingContants.ARG_CHAT_ROOMS)
