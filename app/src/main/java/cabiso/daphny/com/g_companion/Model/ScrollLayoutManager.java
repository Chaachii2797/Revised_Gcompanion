...
/**
 * Created by cicctuser on 10/4/2018.
 */

public class ScrollLayoutManager  extends android.support.v7.widget.LinearLayoutManager {
        ...
        @SuppressWarnings("UnusedDeclaration")
        public ScrollLayoutManager(RecyclerView view) {
        ...
        @SuppressWarnings("UnusedDeclaration")
        public ScrollLayoutManager(RecyclerView view, int orientation, boolean reverseLayout) {
