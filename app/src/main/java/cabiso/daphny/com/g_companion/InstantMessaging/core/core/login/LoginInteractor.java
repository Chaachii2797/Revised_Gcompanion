package cabiso.daphny.com.g_companion.InstantMessaging.core.core.login;
...
public class LoginInteractor implements LoginContract.Interactor {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            updateFirebaseToken(task.getResult().getUser().getUid(),
                                    new SharedPrefUtil(activity.getApplicationContext()).getString(MessagingContants.ARG_FIREBASE_TOKEN, null));
                        } else {
    ...
    private void updateFirebaseToken(String uid, String token) {
        FirebaseDatabase.getInstance()
                .getReference()
                .child(MessagingContants.ARG_USERS)
                .child(uid)
                .child(MessagingContants.ARG_FIREBASE_TOKEN)
                .setValue(token);
    }
}
