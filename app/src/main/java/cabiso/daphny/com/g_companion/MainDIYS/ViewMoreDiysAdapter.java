...
public class ViewMoreDiysAdapter extends RecyclerView.Adapter<ViewMoreDiysAdapter.ViewHolder> {
    ...
    public ViewMoreDiysAdapter(Context context, List<DIYnames> diYnamesList, int GRID){
    ...
    @Override
    public ViewMoreDiysAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.diys_main_items, parent, false);
        // set the view's size, margins, paddings and layout parameters
        return new ViewMoreDiysAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(final ViewMoreDiysAdapter.ViewHolder holder, final int position) {
...
//                            final String key = reference.getRef(position).getKey();
//                            Log.e("keyyy", key);
                        ...
                        if(item.getIdentity().equalsIgnoreCase("on bid!")){
                            for (final DataSnapshot insideDataSnapshot: dataSnapshot.child("bidding").getChildren()) {
                                ...
                                Log.e("biddingItemss", String.valueOf(biddingItem.getIntial_price()));
