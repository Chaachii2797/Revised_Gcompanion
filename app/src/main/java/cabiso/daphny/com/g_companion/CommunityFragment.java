...
public class CommunityFragment extends Fragment{
    ...
    private MarketPlaceFragment.OnListFragmentInteractionListener mListener;
...
//        communityReference = databaseReference.child("diy_by_tags").child(userID).child("business");
        ...
        marketplaceReference = databaseReference.child("diy_by_tags");
    ...
    public void onStart(){
        ...
        FirebaseRecyclerAdapter<ProductInfo, ItemHolder> mAdapter =
                new FirebaseRecyclerAdapter<ProductInfo, ItemHolder>(ProductInfo.class,
                        R.layout.recycler_item, ItemHolder.class, marketplaceReference) {

                    @Override
                    protected void populateViewHolder(final ItemHolder viewHolder, ProductInfo model, final int position) {
...
//            mHeart = (ImageButton) view.findViewById(R.id.heartu);
    ...
    public void onAttach(Context context) {
        ...
        if(context instanceof CommunityFragment.OnListFragmentInteractionListener){
            mListener = (MarketPlaceFragment.OnListFragmentInteractionListener) context;
