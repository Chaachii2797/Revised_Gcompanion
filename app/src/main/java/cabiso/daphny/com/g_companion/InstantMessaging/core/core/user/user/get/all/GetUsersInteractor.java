...
public class GetUsersInteractor implements GetUsersContract.Interactor {
    ...
    public void getAllUsersFromFirebase() {
        FirebaseDatabase.getInstance().getReference().child(MessagingContants.ARG_USERS).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                while (dataSnapshots.hasNext()) {
                    ...
                    if (!TextUtils.equals(user.userID, FirebaseAuth.getInstance().getCurrentUser().getUid())) {
                        users.add(user);
                    }
                }
