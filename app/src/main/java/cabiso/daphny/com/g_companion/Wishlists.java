...
public class Wishlists extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bookmarkReference = FirebaseDatabase.getInstance().getReference().child("bookmarks").child(userID);
        ...
        bookmarkReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (final DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    //init adapter
                    adapter = new BookmarkAdapter(Wishlists.this, R.layout.bookmark_item, bookmrkList);
                    ...
                    lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            ...
                            Toast.makeText(Wishlists.this, "Clicked: " + " " + itemRef.getDiyName(), Toast.LENGTH_SHORT).show();

                            //send data to ViewRelatedDIYS using intent
                            Intent intent = new Intent(Wishlists.this, ViewRelatedDIYS.class);
