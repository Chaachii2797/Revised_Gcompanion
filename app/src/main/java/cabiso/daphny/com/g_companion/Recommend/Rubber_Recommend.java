...
public class Rubber_Recommend extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rubber__recommend);
...
//            DatabaseReference myRef = database.getReference("DIY_Methods").child("category").child("rubber");
//
...
//                    }
//                    //init adapter
//                    adapter = new RecommendDIYAdapter(Rubber_Recommend.this, R.layout.recommend_ui, diyList);
//
...
//            });
//        }else{
//            Toast.makeText(Rubber_Recommend.this, "No available DIY for this category!",Toast.LENGTH_SHORT).show();
